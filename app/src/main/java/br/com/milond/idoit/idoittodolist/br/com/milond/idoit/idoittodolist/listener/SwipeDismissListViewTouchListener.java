...
package br.com.milond.idoit.idoittodolist.br.com.milond.idoit.idoittodolist.listener;
...
public class SwipeDismissListViewTouchListener implements View.OnTouchListener {
    ...
    public SwipeDismissListViewTouchListener(ListView listView, DismissCallbacks callbacks) {
        ...
        mAnimationTime = listView.getContext().getResources().getInteger(android.R.integer.config_mediumAnimTime);
        mListView = listView;
        mCallbacks = callbacks;
        mParentColor = Color.parseColor("#8BC34A");
    }
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (motionEvent.getActionMasked()) {
            case MotionEvent.ACTION_DOWN: {
                ...
                for (int i = 0; i < childCount; i++) {
                    ...
                    if (rect.contains(x, y)) {
                        mDownView = child;
                        mMovingView = mDownView.findViewById(R.id.todo_item_layout);
                        break;
                    }
                }
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (mSwiping) {
                    mMovingView.setTranslationX(deltaX - mSwipingSlop);

                    mDownView.setBackgroundColor(mParentColor);
                    int alp = (int) ((Math.abs(deltaX) / mViewWidth) * 255);
                    mDownView.getBackground().setAlpha(alp);
